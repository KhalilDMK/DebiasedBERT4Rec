...
def dataloader_factory(args):
    ...
    if args.mode in ['train_bert_semi_synthetic', 'tune_bert_semi_synthetic']:
        ...
        train_temporal_popularity, val_temporal_popularity, test_temporal_popularity, train_popularity, val_popularity, test_popularity = dataloader.get_real_properties()
        return train_loader, val_loader, test_loader, train_temporal_popularity, val_temporal_popularity, test_temporal_popularity, train_popularity, val_popularity, test_popularity
